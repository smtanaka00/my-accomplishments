...
const EntryForm = () => {
    ...
    // Edit mode: check if we arrived here with an existing achievement to edit
    ...
    return (
        <div className="flex-col gap-6" style={{ paddingBottom: 'var(--space-8)' }}>
            <header className="flex-col gap-1">
                <h1 className="text-2xl">{isEditMode ? 'Edit Achievement' : 'Log Achievement'}</h1>
                <p className="text-muted text-sm">
                    {isEditMode ? 'Update the details below.' : "Document your win while it's fresh."}
                </p>
            </header>
